...
# 导入新建的对数衰减算法
from algo.Geobiasd_HITS_log import GeobiasedHITS_log 
...
class FaostatRunner:
    ...
    def run_hits(self, use_geo_bias=True, gamma=1.0):
        print(f"\n=== running {'Geo-biased (Logarithmic)' if use_geo_bias else 'vanilla'} HITS ===")
...
def main():
    ...
    # 保护队友的原文件
    if args.Geo:
        prefix = f"log_geobiased_gamma_{args.gamma}"
    else:
        prefix = "log_vanilla"
...
if __name__ == "__main__":
    ...
    2. python main_log.py --Geo
    3. python main_log.py --scope global
    4. python main_log.py --scope global --Geo --year 2021
    5. python main_log.py --scope global --Geo --gamma 1.0
    """
    main()